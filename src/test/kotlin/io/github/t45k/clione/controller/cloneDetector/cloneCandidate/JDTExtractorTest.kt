...
import io.github.t45k.clione.entity.CloneStatus.STABLE
import io.github.t45k.clione.util.EMPTY_NAME_PATH
import kotlin.test.Test
import kotlin.test.assertEquals


internal class JDTExtractorTest {
    companion object {
        // https://github.com/TheAlgorithms/Java/blob/master/Others/Dijkstra.java
        private const val code = """package Others;
...
class Graph {
    ...
    @Test
    fun testBlock() {
        val blocks: List<Pair<LazyCloneInstance, String>> = JavaBlockExtractor().extract(code, EMPTY_NAME_PATH, STABLE)
